...
import com.victor.ktv.holder.SungContentViewHolder;
...
public class SungListAdapter extends BaseRecycleAdapter<MusicData, RecyclerView.ViewHolder> {
    private int currentPosition = -1;
    public SungListAdapter(Context context, AdapterView.OnItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateContentVHolder(ViewGroup parent, int viewType) {
        return new SungContentViewHolder(mLayoutInflater.inflate(R.layout.rv_sung_cell, parent, false));
    }

    @Override
    public void onBindContentVHolder(RecyclerView.ViewHolder viewHolder, MusicData data, int position) {
        SungContentViewHolder contentViewHolder = (SungContentViewHolder) viewHolder;
