...
public class HotSongListFragment extends BaseFragment implements PagingScrollHelper.onPageChangeListener,
    ...
    public static HotSongListFragment newInstance () {
        HotSongListFragment fragment = new HotSongListFragment();
...
//        bundle.putInt(FOLLOW_USER_ID_KEY,followUserId);
    ...
    protected int getLayoutResource() {
        return R.layout.frag_hot_song_list;
    }
