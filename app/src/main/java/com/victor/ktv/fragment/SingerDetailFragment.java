...
public class SingerDetailFragment extends BaseFragment implements PagingScrollHelper.onPageChangeListener,
    ...
    public static SingerDetailFragment newInstance () {
...
//        bundle.putInt(FOLLOW_USER_ID_KEY,followUserId);
    ...
    protected int getLayoutResource() {
        return R.layout.frag_singer_detail;
    }
    ...
    public void initialize () {
        ...
        horizontalPageLayoutManager = new HorizontalPageLayoutManager(4,2);
        ...
        switch (view.getId()) {
            ...
            case R.id.iv_secondary_home:
                ...
                if (singerFragment != null) {
                    singerFragment.switchFragment(SingerContentFragment.newInstance());
                }
                break;
        }
    }
