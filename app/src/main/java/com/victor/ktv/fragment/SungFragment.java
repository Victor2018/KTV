...
import com.victor.ktv.adapter.SungListAdapter;
...
public class SungFragment extends BaseFragment implements PagingScrollHelper.onPageChangeListener,
    ...
    private SungListAdapter sungListAdapter;
    private int currentIndex;

    public static SungFragment newInstance () {
        SungFragment fragment = new SungFragment();
...
//        bundle.putInt(FOLLOW_USER_ID_KEY,followUserId);
    ...
    public void initialize () {
        ...
        sungListAdapter = new SungListAdapter(getContext(),this);
        sungListAdapter.setHeaderVisible(false);
        sungListAdapter.setFooterVisible(false);

        mRvSongList.setAdapter(sungListAdapter);
    ...
    private void initData() {
        for (int i=0;i<10;i++) {
            ...
            data.title = "十年 HD" + i;
            data.artist = "陈奕迅" + i;
            sungListAdapter.add(data);
        }
        sungListAdapter.notifyDataSetChanged();
