...
public class SongListContentViewHolder extends ContentViewHolder implements View.OnClickListener {
    ...
    public TextView mTvTitle,mTvSinger,mTvLanguage,mTvRanking;
    public ImageView mIvFire,mIvRanking;

    public void setOnItemClickListener(AdapterView.OnItemClickListener listener) {
        mOnItemClickListener = listener;
    }

    public SongListContentViewHolder(View view) {
        super(view);
        mTvTitle = view.findViewById(R.id.tv_title);
        mTvSinger = view.findViewById(R.id.tv_singer);
        mTvLanguage = view.findViewById(R.id.tv_language);
        mTvRanking = view.findViewById(R.id.tv_ranking);
        mIvRanking = view.findViewById(R.id.iv_ranking);
        mIvFire = view.findViewById(R.id.iv_fire);
